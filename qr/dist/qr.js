...
var QR = /** @class */ (function () {
    function QR(text, version, lvlCorrection) {
        this.text = text;
    ...
    QR.prototype.firstPart = function () {
        ...
        if (this.text.length <= this.capacity) {
            ...
            console.log("dimensiones de texto incorrecta");
        }
        ...
        var cci = this.complete(this.text.length.toString(2), this.ccm);
    ...
    QR.prototype.dataEncoding = function () {
        var data = this.firstPart() + this.msgEncoding();
        var totalNumberData = [{ "L": 19, "M": 16, "Q": 13, "H": 9 }, { "L": 34, "M": 28, "Q": 22, "H": 16 }, { "L": 55, "M": 44, "Q": 34, "H": 26 }, { "L": 80, "M": 64, "Q": 48, "H": 36 }, { "L": 108, "M": 86, "Q": 62, "H": 46 }, { "L": 136, "M": 108, "Q": 76, "H": 60 }, { "L": 156, "M": 124, "Q": 88, "H": 66 }, { "L": 194, "M": 154, "Q": 110, "H": 86 }, { "L": 232, "M": 182, "Q": 132, "H": 100 }, { "L": 274, "M": 216, "Q": 154, "H": 122 }, { "L": 324, "M": 254, "Q": 180, "H": 140 }, { "L": 370, "M": 290, "Q": 206, "H": 158 }, { "L": 428, "M": 334, "Q": 244, "H": 180 }, { "L": 461, "M": 365, "Q": 261, "H": 197 }, { "L": 523, "M": 415, "Q": 295, "H": 223 }, { "L": 589, "M": 453, "Q": 325, "H": 253 }, { "L": 647, "M": 507, "Q": 367, "H": 283 }, { "L": 721, "M": 563, "Q": 397, "H": 313 }, { "L": 795, "M": 627, "Q": 445, "H": 341 }, { "L": 861, "M": 669, "Q": 485, "H": 385 }, { "L": 932, "M": 714, "Q": 512, "H": 406 }, { "L": 1006, "M": 782, "Q": 568, "H": 442 }, { "L": 1094, "M": 860, "Q": 614, "H": 464 }, { "L": 1174, "M": 914, "Q": 664, "H": 514 }, { "L": 1276, "M": 1000, "Q": 718, "H": 538 }, { "L": 1370, "M": 1062, "Q": 754, "H": 596 }, { "L": 1468, "M": 1128, "Q": 808, "H": 628 }, { "L": 1531, "M": 1193, "Q": 871, "H": 661 }, { "L": 1631, "M": 1267, "Q": 911, "H": 701 }, { "L": 1735, "M": 1373, "Q": 985, "H": 745 }, { "L": 1843, "M": 1455, "Q": 1033, "H": 793 }, { "L": 1955, "M": 1541, "Q": 1115, "H": 845 }, { "L": 2071, "M": 1631, "Q": 1171, "H": 901 }, { "L": 2191, "M": 1725, "Q": 1231, "H": 961 }, { "L": 2306, "M": 1812, "Q": 1286, "H": 986 }, { "L": 2434, "M": 1914, "Q": 1354, "H": 1054 }, { "L": 2566, "M": 1992, "Q": 1426, "H": 1096 }, { "L": 2702, "M": 2102, "Q": 1502, "H": 1142 }, { "L": 2812, "M": 2216, "Q": 1582, "H": 1222 }, { "L": 2956, "M": 2334, "Q": 1666, "H": 1276 }];
        var requiredBits = totalNumberData[this.version - 1][this.lvlCorrection];
        console.log("required: ", requiredBits);
        // add terminator
        if (data.length < requiredBits * 8) {
            if (data.length + 4 <= requiredBits) {
                data += "0000";
            }
            else {
                data += "00";
    ...
    // Error encoding 
    QR.prototype.getAntilog = function (val) { return this.antilog[val]; };
    QR.prototype.getStep = function (g0, g1) {
        var array = [];
        for (var i = 0; i < g0.length; i++) {
            for (var j = 0; j < g1.length; j++) {
                var value = g0[i] + g1[j] < 255 ? g0[i] + g1[j] : g0[i] + g1[j] - 255;
                var index = i + j;
                if (array[index] == undefined) {
                    array[index] = value;
                }
                else {
                    var lval = this.getAntilog(array[index]) ^ this.getAntilog(value);
